...
exports.config = {
  debug: true,
  name: 'Creative Club',
  description: 'Creative Club is based on Node Club',
  version: '0.1.1',
  ...
  site_google_search_domain:  'creativeclub.net',  // google search preview中要搜索的域名

  upload_dir: path.join(__dirname, 'public', 'user_data', 'images'),

  db: 'mongodb://127.0.0.1/creativeclub',
  ...
  rss: {
    title: 'creativeclub',
    link: 'creativeclub.net',
    language: 'zh-cn',
    description: 'creativeclub.net',
  ...
  mail_opts: {
    ...
    port: 25,
    auth: {
      user: 'creativeclub.net@gmail.com',
      pass: 'creativeclub.net'
    }
  },
